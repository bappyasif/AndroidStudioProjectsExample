...
public class PetProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        //Figure out if the URI matcher matches the specefic code.
        ...
        switch (match) {
            ...
            case PET_ID:
                ...
                //Cursor will contain the row of the table that we intended
                cursor = database.query(PetEntry.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
        ...
        //If the Data of this URI changes , then we know need to update the cursor.
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        //notify all listeners that the data hass changed for the pet content URI
