...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            String jsonResponse = "";
            // If the URL is null return early. no need to parse.
            if(url == null){
                return jsonResponse;
            }
            ...
            try {
                ...
                //If the request was succesful the read the input stream and parse the content
                if (urlConnection.getResponseCode()==200){
                    inputStream = urlConnection.getInputStream();
                    jsonResponse = readFromStream(inputStream);
                }else {
                    Log.e(LOG_TAG, "Error response oode " +urlConnection.getResponseCode());
                }
            } catch (IOException e) {
                // TODO: Handle the exception
                // Log the IOException when it gets thrown
